...
// Constructeur
CelestialBody::CelestialBody(double massIn, Vector2D posIn) : diameter{10}, mass{massIn}, position{posIn}, velocity{Vector2D{0, 0}}, color{(sf::Uint8)(rand() % 255), (sf::Uint8)(rand() % 255), (sf::Uint8)(rand() % 255)}
{
}

CelestialBody::CelestialBody(double diameter, double massIn, Vector2D posIn, Vector2D velocity)
    : diameter{diameter}, mass{massIn}, position{posIn}, velocity{velocity}, color{(sf::Uint8)(rand() % 255), (sf::Uint8)(rand() % 255), (sf::Uint8)(rand() % 255)} {}
